return {
  {
    ...
    config = function()
      ...
      -- Si el build de telescope-fzf-native falló (falta compilador,
      -- mismatch de ABI tras actualizar nvim, etc.) esto no debe
      -- tumbar el resto del config ni dejar los keymaps sin registrar.
